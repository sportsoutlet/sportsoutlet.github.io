...
Maintain a professional tone. Do not include bullet points or formatting markers in the output. If there is a game highlight included within the content, somewhere in the middle place the text: "%gamehighlight%", a youtube video will later be imbeded there, make sure it does not seperate text, be sure to have something to introduce the highlights as well with a colon, they will most likely be a compilation of videos, be generous when using <strong> tags for bolding things like scores, or other important pieces, make sure to not use tags surrounding the video highlight marker, also do not put line breaks around the video, the video will have spacing already. Again, do not forget to do this if there is a game highlight available. use line breaks in between each paragraph - <div></div>. make sure to not put a period after the video highlight. Generate a short, engaging, fan-friendly title for this recap.
