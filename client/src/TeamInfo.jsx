...
function TeamInfo({setDisplaySummary, setActiveTeam, activeTeam, recap, name}) { 
    ...
    return (
        ...
        <button onClick={() => setDisplaySummary(true)}><div className="team-info p-4"><h2 className="text-left text-2xl mb-4">{recap.summaryTitle}</h2><p className="text-left" dangerouslySetInnerHTML={{ __html: htmlTruncate(recap.summary.replace('%user%', name), 250) }}></p></div></button>
